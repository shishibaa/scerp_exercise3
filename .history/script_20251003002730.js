...
function renderList(list) {
    ...
    list.forEach(member => {
        ...
        if (member.website && isValidUrl(member.website)) {
            website = `<a href="${member.website}" target="_blank" rel="noopener noreferrer">Visit</a>`;
        } else {
            website = `<a href="#" onclick="alert('The website is under construction'); return false;">Visit</a>`;
        }
        div.innerHTML = `
